...
void main() {
  group('UnionShopApp', () {
    testWidgets('creates MaterialApp with correct routes', (tester) async {
      ...
      await tester.pump(const Duration(milliseconds: 50)); // bounded pump
  ...
  group('HomeScreen', () {
    ...
    testWidgets('carousel next button works', (tester) async {
      ...
      await tester.pump(const Duration(milliseconds: 300)); // animate bounded
    ...
    testWidgets('displays carousel navigation dots', (tester) async {
      ...
      // Should have at least 4 tappable dots if implemented with GestureDetector
